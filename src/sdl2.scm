...
(define SDL_Log (c-lambda (nonnull-char-string) void "SDL_Log"))
(define SDL_LogCritical (c-lambda (int nonnull-char-string) void "SDL_LogCritical"))
(define SDL_LogDebug (c-lambda (int nonnull-char-string) void "SDL_LogDebug"))
(define SDL_LogError (c-lambda (int nonnull-char-string) void "SDL_LogError"))
...
(define SDL_LogInfo (c-lambda (int nonnull-char-string) void "SDL_LogInfo"))
(define SDL_LogMessage (c-lambda (int SDL_LogPriority nonnull-char-string) void "SDL_LogMessage"))
...
(define SDL_LogVerbose (c-lambda (int nonnull-char-string) void "SDL_LogVerbose"))
(define SDL_LogWarn (c-lambda (int nonnull-char-string) void "SDL_LogWarn"))
...
(define SDL_SetError (c-lambda (nonnull-char-string) int "SDL_SetError"))
